...
export enum TenantStatus { PROVISIONING = 'PROVISIONING', ACTIVE = 'ACTIVE', SUSPENDED = 'SUSPENDED' }
...
export class Tenant {
  ...
  @Column({ type: 'enum', enum: TenantStatus, default: TenantStatus.PROVISIONING }) status!: TenantStatus;
